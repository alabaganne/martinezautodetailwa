...
export const testLocationDetails = async () => {
  try {
...
export const testTeamMembers = async () => {
  try {
...
export const runAllTests = async () => {
  const tests = [
    ...
    { name: 'Location Details', fn: testLocationDetails },
    { name: 'Customer Operations', fn: testCustomerOperations },
    { name: 'Catalog Items', fn: testCatalogItems },
    { name: 'Team Members', fn: testTeamMembers },
    { name: 'Bookings API', fn: testBookingsApi },
  ];
