...
const GroupedBookingList: React.FC<GroupedBookingListProps> = React.memo(
	({ bookings, onStatusUpdate, onCancel }) => {
						...
						<div key={dateKey} className="relative">
							...
							<div
								...
								{dayBookings.map((booking) => (
									<div key={booking.id}>
										<BookingCard booking={booking} onStatusUpdate={onStatusUpdate} onCancel={onCancel} />
									</div>
								))}
							</div>
						</div>
	...
	(prevProps, nextProps) => {
		...
		return (
			prevProps.bookings === nextProps.bookings && prevProps.onStatusUpdate === nextProps.onStatusUpdate && prevProps.onCancel === nextProps.onCancel
		);
	}
);
