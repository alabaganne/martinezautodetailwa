      ...
      <div className="relative flex flex-col gap-4">
        ...
        <div>
          ...
          <div className="mt-3 text-sm text-gray-600">
            {dateFilterType === 'all' ? (
              <span>Showing <span className="font-semibold text-gray-900">all bookings</span></span>
            ) : dateFilterType === 'week' ? (
              <span>Showing bookings for <span className="font-semibold text-gray-900">this week</span></span>
            ) : dateFilterType === 'today' ? (
              <span>Showing bookings for <span className="font-semibold text-gray-900">today</span></span>
            ) : (
              <span>Showing bookings for <span className="font-semibold text-gray-900">{formatDate(selectedDate)}</span></span>
            )}
          </div>
        </div>
      </div>
